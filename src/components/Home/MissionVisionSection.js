...
//         <motion.div className="relative top-12  md:w-2/6" variants={imageVariants}>
//           <Image
...
const MissionVisionSection = () => {
  ...
  return (
    <section className="bg-black text-white p-8">
      ...
      >
        {/* Top Image */}
        <motion.div className="relative  md:w-6/12 w-full lg:w-2/6 px-8" variants={imageVariants}>
          <Image
            src="/History-Img.jpeg"
            alt="Mission Vision Image"
            className="w-full h-auto object-cover rounded border-4 border-white"
        ...
        {/* Mission Section */}
        <motion.div className="py-12 px-8 w-full md:max-w-8xl md:w-8/12 max-w-4xl text-center md:text-left" variants={headingVariants}>
          <motion.h1 className="text-3xl md:text-4xl font-bold mb-6">Our Mission</motion.h1>
      ...
      >
        <motion.div className="text-center md:text-left" variants={headingVariants}>
          <motion.h2 className="text-3xl font-bold mb-4">Our Vision</motion.h2>
          <motion.p className="text-gray-400 mb-4" variants={textVariants}>
            Our vision is to be the leading provider of special education camps for programming, empowering students to achieve their full potential.
          </motion.p>
          <motion.button className="bg-white text-red-600 hover:text-white hover:bg-red-700 transition duration-300 text-lg py-3 px-8 rounded-xl shadow-lg font-bold" variants={textVariants}>
            Learn more
          </motion.button>
        </motion.div>

        <motion.div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-center" variants={containerVariants}>
          {[
            { src: '/line-chart.png', alt: 'Line Chart', text: 'Empower students with skills for success in the digital economy.' },
            { src: '/pie-chart.png', alt: 'Pie Chart', text: 'Deliver the best learning experience for success in the digital world.' },
            { src: '/flag.png', alt: 'Flag', text: 'Foster innovation and creativity by encouraging students to think creatively.' },
